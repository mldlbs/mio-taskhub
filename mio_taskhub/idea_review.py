# Module proxy stub — real code in ideas/idea_review.py
# Ensures monkeypatch.setattr/patch.object on this module affects the real submodule's globals.
import sys as _sys
import importlib as _importlib

_real_name = 'mio_taskhub.ideas.idea_review'
