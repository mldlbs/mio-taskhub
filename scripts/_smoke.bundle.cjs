...
// mio-taskhub/web/node_modules/react/cjs/react.production.min.js
var require_react_production_min = __commonJS({
  "mio-taskhub/web/node_modules/react/cjs/react.production.min.js"(exports2) {
    "use strict";
...
// mio-taskhub/web/node_modules/react/cjs/react.development.js
var require_react_development = __commonJS({
  "mio-taskhub/web/node_modules/react/cjs/react.development.js"(exports2, module2) {
    "use strict";
...
// mio-taskhub/web/node_modules/react/index.js
var require_react = __commonJS({
  "mio-taskhub/web/node_modules/react/index.js"(exports2, module2) {
    "use strict";
    if (process.env.NODE_ENV === "production") {
...
// mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server-legacy.node.production.min.js
var require_react_dom_server_legacy_node_production_min = __commonJS({
  "mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server-legacy.node.production.min.js"(exports2) {
    "use strict";
...
// mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server.node.production.min.js
var require_react_dom_server_node_production_min = __commonJS({
  "mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server.node.production.min.js"(exports2) {
    "use strict";
    var aa = require("util");
...
// mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js
var require_react_dom_server_legacy_node_development = __commonJS({
  "mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js"(exports2) {
    "use strict";
    if (process.env.NODE_ENV !== "production") {
      (function() {
        "use strict";
...
// mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server.node.development.js
var require_react_dom_server_node_development = __commonJS({
  "mio-taskhub/web/node_modules/react-dom/cjs/react-dom-server.node.development.js"(exports2) {
    "use strict";
    if (process.env.NODE_ENV !== "production") {
      (function() {
        "use strict";
...
// mio-taskhub/web/node_modules/react-dom/server.node.js
var require_server_node = __commonJS({
  "mio-taskhub/web/node_modules/react-dom/server.node.js"(exports2) {
    "use strict";
    var l;
    var s;
    if (process.env.NODE_ENV === "production") {
...
// mio-taskhub/web/_smoke_entry.mjs
var import_react2 = __toESM(require_react(), 1);
var import_server = __toESM(require_server_node(), 1);

// mio-taskhub/web/src/components/TopoView.jsx
var import_react = __toESM(require_react(), 1);

// mio-taskhub/web/src/constants.js
var LANES = [
...
var STATE_META = Object.fromEntries(LANES.map((l) => [l.id, l]));
var PRIORITY = [
  { p: 0, label: "P0", text: "\u4F4E" },
  { p: 1, label: "P1", text: "\u4E2D" },
  { p: 2, label: "P2", text: "\u9AD8" },
...
var prio = (p) => PRIORITY[Math.min(3, Math.max(0, p ?? 0))];
var fmtDur = (min) => {
  if (min == null) return "\u2014";
...
function computeCPM(tasks, opts = {}) {
  const byId = Object.fromEntries(tasks.map((t) => [t.id, t]));
  const dur = {};
  tasks.forEach((t) => {
    dur[t.id] = taskDuration(t);
  });
  ...
  order.forEach((id) => {
    deps[id].forEach((d) => {
      layer[id] = Math.max(layer[id], layer[d] + 1);
    });
  });
  const layerWidth = {};
  tasks.forEach((t) => {
    layerWidth[layer[t.id]] = (layerWidth[layer[t.id]] || 0) + 1;
  });
  const parallel = Object.keys(layerWidth).length ? Math.max(...Object.values(layerWidth)) : 0;
  const crit = {};
  tasks.forEach((t) => {
    crit[t.id] = float[t.id] <= EPSILON;
  });
  if (order.length < tasks.length) {
    tasks.forEach((t) => {
      if (!inOrder.has(t.id)) crit[t.id] = false;
    });
  }
  ...
  const dfs = (id, path, onPath) => {
    ...
    const cur2 = path.concat(id);
    if (isTerminal(id)) {
      allCriticalPaths.push(cur2);
      return;
    }
    const nextOn = new Set(onPath).add(id);
    (succ[id] || []).forEach((c) => {
      if (crit[c]) dfs(c, cur2, nextOn);
    });
  };
  tasks.forEach((t) => {
    if (crit[t.id] && isRoot(t.id)) dfs(t.id, [], /* @__PURE__ */ new Set());
  });
  const onAny = /* @__PURE__ */ new Set();
  allCriticalPaths.forEach((p) => p.forEach((id) => onAny.add(id)));
  tasks.forEach((t) => {
    critical[t.id] = onAny.has(t.id);
  });
  const ev = [];
  tasks.forEach((t) => {
  ...
  const maxParallel = opts.maxParallel !== void 0 ? opts.maxParallel : agentSet.size || null;
...
function TopoView({ tasks, onOpen }) {
  const [hoveredId, setHoveredId] = (0, import_react.useState)(null);
  const [showAll, setShowAll] = (0, import_react.useState)(false);
  const { layers } = (0, import_react.useMemo)(() => kahnLayers(tasks), [tasks]);
  const cpm = (0, import_react.useMemo)(() => computeCPM(tasks), [tasks]);
  const critIds = (0, import_react.useMemo)(() => {
    if (showAll) {
  ...
  const byId = Object.fromEntries(tasks.map((t) => [t.id, t]));
  const isBlocked = (t) => (t.depends_on || []).some((d) => {
    const dep = byId[d];
  ...
  const connectedIds = (id) => {
    ...
    tasks.forEach((x) => {
      if ((x.depends_on || []).includes(id)) out.add(x.id);
    });
    return out;
  };
  return /* @__PURE__ */ React.createElement("div", { className: "topo" }, /* @__PURE__ */ React.createElement("div", { className: "topo__head" }, /* @__PURE__ */ React.createElement("h2", { className: "topo__title" }, "\u4F9D\u8D56\u62D3\u6251"), /* @__PURE__ */ React.createElement(
    "button",
    {
      className: `btn btn--ghost topo__toggle${showAll ? " is-active" : ""}`,
      onClick: () => setShowAll((s) => !s),
      "aria-pressed": showAll
    },
    showAll ? `\u5168\u90E8\u5173\u952E\u8DEF\u5F84 (${cpm.allCriticalPaths.length})` : "\u5355\u6761\u5173\u952E\u8DEF\u5F84"
  ), /* @__PURE__ */ React.createElement("span", { className: "topo__count" }, tasks.length, " \u4E2A\u4EFB\u52A1 \xB7 ", layers.length, " \u5C42")), /* @__PURE__ */ React.createElement("div", { className: "topo__metrics" }, /* @__PURE__ */ React.createElement("span", null, "\u603B\u5DE5\u671F ", fmtDur(cpm.total)), /* @__PURE__ */ React.createElement("span", null, "\u5173\u952E\u8DEF\u5F84 ", cpm.allCriticalPaths.length, " \u6761"), /* @__PURE__ */ React.createElement("span", null, "\u5E76\u884C\u5EA6 ", cpm.parallel), /* @__PURE__ */ React.createElement("span", null, "\u51B2\u7A81 ", cpm.resourceConflicts.length, " \u6BB5"), /* @__PURE__ */ React.createElement("span", null, "\u963B\u585E ", tasks.filter(isBlocked).length)), layers.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "topo__empty" }, "\u8FD8\u6CA1\u6709\u4EFB\u52A1\u3002"), layers.map((layer, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "topo__layer" }, /* @__PURE__ */ React.createElement("div", { className: "topo__layer-tag" }, "L", i + 1), /* @__PURE__ */ React.createElement("div", { className: "topo__layer-nodes" }, layer.map((t) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      {
        key: t.id,
        className: `topo-node topo-node--${tone}${hl ? " is-hovered" : ""}${crit ? " is-critical" : ""}`,
        role: "button",
        tabIndex: 0,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "topo-node__title" }, t.title),
      /* @__PURE__ */ React.createElement("div", { className: "topo-node__meta" }, /* @__PURE__ */ React.createElement("span", { className: `chip${p.p >= 3 ? " chip--p3" : ""}${p.p === 2 ? " chip--p2" : ""}` }, p.label), /* @__PURE__ */ React.createElement("span", { className: "topo-node__stage" }, t.stage)),
      /* @__PURE__ */ React.createElement("div", { className: "topo-node__stats" }, /* @__PURE__ */ React.createElement("span", null, fmtDur(t.est_duration_min)), /* @__PURE__ */ React.createElement("span", null, blocked ? "\u963B\u585E" : crit ? "\u5173\u952E" : `\u6D6E\u52A8 ${fmtDur(flt)}`))
    );
  })))));
}
...
for (const c of cases) {
  try {
    const html = (0, import_server.renderToStaticMarkup)(import_react2.default.createElement(TopoView, { tasks: c.tasks, onOpen: () => {
    } }));
